...
- **Reset:** Wszystkie ustawienia (kolor, przynależność do zespołu, status pierwszego uruchomienia) znajdują się jako pliki JSON w katalogu danych aplikacji Tauri (`settings.json`, `auth.json`). Usunięcie tych plików całkowicie resetuje aplikację.
